  ...
  return (
    <div id='contact' className='w-full lg:h-screen'>
        <div className='max-w-[1240px] m-auto px-2 py-16 w-full'>
            <p className='text-xl tracking-widest uppercase text-[#226CE0]'>Contact</p>
            ...
            <div className='grid lg:grid-cols-5 gap-8'>
                <div className='col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4'>
                    <div className='lg:p-4 h-full'>
                        ...
                        <div className=''>
                            <h2 className=' py-2'>Dedit Hery Suprastyo</h2>
                        ...
                        <form>
                            <div className='grid md:grid-cols-2 gap-4 w-full py-2'>
                                <div className='flex flex-col py-2'>
                                    ...
                                    <input className='border-2 rounded-xl p-3 flex border-gray-300' type="text" />
                                </div>
                                <div className='flex flex-col py-2'>
                            ...
                            <div className='flex flex-col py-2'>
                                ...
                                <input className='border-2 rounded-xl p-3 flex border-gray-300' type="email" />
                            </div>
                            <div className='flex flex-col py-2'>
            ...
            <div className='flex justify-center py-12'>
                <Link href='/'>
                    <div className='rounded-full shadow-lg shadow-gray-400 p-4 cursor-pointer hover:scale-110 ease-in duration-300'>
                        <HiOutlineChevronDoubleUp className='text-[#226CE0]' size={30} />
                    </div>
                </Link>
            </div>
        </div>
